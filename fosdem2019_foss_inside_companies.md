...
For me, I think success comes from having … enabling the developers within my company to do their job and to do it well. And what I mean by that is if you go back maybe ten years ago, it was pretty hard to just release some software, just to put some software in the hands of your potential customer and user base. So, everyone went through the processes that Cisco put in place to put software out. There wasn’t ability to open source something. But the ability to just put any kind of software out, or product, whether it’s open source of closed source, was pretty difficult process, pretty arduous process.
